//
//  TableViewCellLongLongComment.m
//  DaliyNews
//
//  Created by 李育腾 on 2022/11/1.
//
...
#import <Masonry.h>
@implementation TableViewCellLongLongComment
...
//    _labelUserName.text = @"Ossiroal";
    ...
    _labelUserComment.text = @"为了科普也值了， 至少学到了知识！";
    ...
    _labelUserReplayComment.text = @"3条短评";
    ...
    _labelReplayTime.text = @"10-27 00:32";
